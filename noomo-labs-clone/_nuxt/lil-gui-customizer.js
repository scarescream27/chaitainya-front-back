/**
 * ============================================================================
 * File: lil-gui-customizer.js
 * Purpose: lil-gui 0.19.2 library: Interactive glass material customizer panel for adjusting refraction, roughness, thickness, and color.
 * ============================================================================
 */
/**
 * lil-gui
 ...
 */ class c {
  constructor(t, i, e, l, r = "div") {
    ((this.parent = t),
      ...
      this.domElement.classList.add(l),
      (this.$name = document.createElement("div")),
      this.$name.classList.add("name"),
      (c.nextNameID = c.nextNameID || 0),
      (this.$name.id = `lil-gui-name-${++c.nextNameID}`),
...
class O extends c {
  constructor(t, i, e, l) {
    (super(t, i, e, "color"),
      ...
      (this._format = M(this.initialValue)),
      (this._rgbScale = l),
...
class y extends c {
  constructor(t, i, e) {
    (super(t, i, e, "function"),
      ...
      this.$button.addEventListener("click", (l) => {
        (l.preventDefault(),
...
class z extends c {
  constructor(t, i, e, l, r, o) {
    (super(t, i, e, "number"), this._initInput(), this.min(l), this.max(r));
    const d = o !== void 0;
  ...
  _initInput() {
    ...
    const t = () => {
        ...
        isNaN(s) ||
          (this._stepExplicit && (s = this._snap(s)),
          this.setValue(this._clamp(s)));
      },
      i = (s) => {
        const a = parseFloat(this.$input.value);
        isNaN(a) ||
          (this._snapClampSetValue(a + s),
          (this.$input.value = this.getValue()));
      },
      e = (s) => {
        (s.key === "Enter" && this.$input.blur(),
          s.code === "ArrowUp" &&
            (s.preventDefault(), i(this._step * this._arrowKeyMultiplier(s))),
          s.code === "ArrowDown" &&
            (s.preventDefault(),
            i(this._step * this._arrowKeyMultiplier(s) * -1)));
      },
      l = (s) => {
        this._inputFocused &&
          (s.preventDefault(), i(this._step * this._normalizeMouseWheel(s)));
      };
    let r = !1,
      o,
      d,
    ...
    const m = 5,
      ...
      f = (s) => {
        ...
        if (!r) {
          const a = s.clientY - p;
          ((u -= a * this._step * this._arrowKeyMultiplier(s)),
            h + u > this._max
              ? (u = this._max - h)
    ...
    (this.$input.addEventListener("input", t),
      ...
      this.$input.addEventListener("mousedown", v),
  ...
  _initSlider() {
    ...
    const t = (s, a, g, E, k) => ((s - a) / (g - a)) * (k - E) + E,
      i = (s) => {
    ...
    const h = (s) => {
      ...
      u = (s) => {
        s.touches.length > 1 ||
          (this._hasScrollBar
            ? ((d = s.touches[0].clientX), (p = s.touches[0].clientY), (o = !0))
            : h(s),
      ...
      m = (s) => {
        if (o) {
          const a = s.touches[0].clientX - d,
            g = s.touches[0].clientY - p;
          Math.abs(a) > Math.abs(g)
            ? h(s)
            : (window.removeEventListener("touchmove", m),
              window.removeEventListener("touchend", v));
        } else (s.preventDefault(), i(s.touches[0].clientX));
      },
      v = () => {
        (this._callOnFinishChange(),
          this._setDraggingStyle(!1),
    ...
    let w;
    const _ = (s) => {
      if (Math.abs(s.deltaX) < Math.abs(s.deltaY) && this._hasScrollBar) return;
      s.preventDefault();
      const a = this._normalizeMouseWheel(s) * this._step;
      (this._snapClampSetValue(this.getValue() + a),
        (this.$input.value = this.getValue()),
        clearTimeout(w),
        (w = setTimeout(f, b)));
    };
    (this.$slider.addEventListener("mousedown", e),
      ...
      this.$slider.addEventListener("wheel", _, { passive: !1 }));
  }
...
class $ {
  constructor({
    ...
    if (
      ...
      this.$title.addEventListener("keydown", (h) => {
        (h.code === "Enter" || h.code === "Space") &&
          (h.preventDefault(), this.$title.click());
      }),
    ...
    (this.domElement.classList.add("root"),
      p && this.domElement.classList.add("allow-touch-styles"),
      !C && d && (Y(H), (C = !0)),
      e
  ...
  add(t, i, e, l, r) {
    if (Object(e) === e) return new B(this, t, i, e);
    const o = t[i];
    switch (typeof o) {
      case "number":
        return new z(this, t, i, e, l, r);
      case "boolean":
  ...
  addFolder(t) {
    const i = new $({ parent: this, title: t });
