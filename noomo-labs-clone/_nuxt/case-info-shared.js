/**
 * ============================================================================
 * File: case-info-shared.js
 * Purpose: Case study shared layout template, high-res image viewer, and swiper carousel.
 * ============================================================================
 */
import {
  q as f,
  ...
  jt = Promise.all([
    ...
    var K = 0.001,
      ...
      Pt = class {
        ...
        get delta() {
          return this._delta * K;
        }
        get fixedDelta() {
          return this._fixedDelta * K;
        }
        set fixedDelta(e) {
          this._fixedDelta = e * Rt;
        }
        get elapsed() {
          return this._elapsed * K;
        }
        update(e) {
          (this.useFixedDelta
    ...
    function Ot() {
      if (T === null) {
        ...
        ((T = new Kt()),
          T.setAttribute !== void 0
            ? (T.setAttribute("position", new W(e, 3)),
              T.setAttribute("uv", new W(t, 2)))
            : (T.addAttribute("position", new W(e, 3)),
              T.addAttribute("uv", new W(t, 2))));
      }
      return T;
    }
    var E = class Mt {
        constructor(t = "Pass", i = new vt(), r = yt) {
          ((this.name = t),
            (this.renderer = null),
            (this.scene = i),
            (this.camera = r),
        ...
        set fullscreenMaterial(t) {
          ...
          i !== null
            ...
            : ((i = new Yt(Ot(), t)),
              (i.frustumCulled = !1),
              this.scene === null && (this.scene = new vt()),
              this.scene.add(i),
              (this.screen = i));
        }
      ...
      Ht = Number(X.replace(/\D+/g, ""));
    function J(e) {
      return Ht < 154
        ? e.replace("colorspace_fragment", "encodings_fragment")
        : e;
    }
    let oe,
      F,
...
#include <dithering_fragment>
      ...
      (j = class extends S {
        constructor() {
          (super({
            name: "CopyMaterial",
            uniforms: { inputBuffer: new c(null), opacity: new c(1) },
            blending: P,
            toneMapped: !1,
            depthWrite: !1,
            depthTest: !1,
          ...
          i !== void 0 &&
            ...
            i !== R
              ? (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH =
                  "1")
              : e !== null &&
                e.outputColorSpace === D &&
                (this.renderTarget.texture.colorSpace = D));
        }
      }),
      (q = new ft()),
      (b = class extends E {
      ...
      (ce = class extends E {
        ...
        render(e, t, i, r, s) {
          ...
          (a.color.setMask(!1),
            ...
            a.stencil.setFunc(n.ALWAYS, B, 4294967295),
            a.stencil.setClear(g),
      ...
      (It = class {
        ...
        setRenderer(e) {
          if (((this.renderer = e), e !== null)) {
            const t = e.getSize(new f()),
              i = e.getContext().getContextAttributes().alpha,
              r = this.inputBuffer.texture.type;
            (r === R &&
              e.outputColorSpace === D &&
              ((this.inputBuffer.texture.colorSpace = D),
              (this.outputBuffer.texture.colorSpace = D),
              this.inputBuffer.dispose(),
              this.outputBuffer.dispose()),
              (e.autoClear = !1),
        ...
        createBuffer(e, t, i, r) {
          const s = this.renderer,
            n = s === null ? new f() : s.getDrawingBufferSize(new f()),
            a = {
              minFilter: O,
              magFilter: O,
              stencilBuffer: t,
          ...
          return (
            ...
            i === R &&
              s !== null &&
              s.outputColorSpace === D &&
              (o.texture.colorSpace = D),
        ...
        addPass(e, t) {
          const i = this.passes,
            r = this.renderer,
            s = r.getDrawingBufferSize(new f()),
        ...
        removePass(e) {
          ...
          if (i !== -1 && t.splice(i, 1).length > 0) {
            if (this.depthTexture !== null) {
              const r = (s, n) => s || n.needsDepthTexture;
              t.reduce(r, !1) ||
          ...
          for (const d of this.passes)
            d.enabled &&
              ...
              d.needsSwap &&
                ...
                (r = s),
                (s = l)),
              d instanceof ce ? (n = !0) : d instanceof Lt && (n = !1));
        }
        setSize(e, t, i) {
          ...
          const n = r.getDrawingBufferSize(new f());
      ...
      (C = { NONE: 0, DEPTH: 1, CONVOLUTION: 2 }),
      (u = {
      ...
      (Ae = class {
        constructor() {
          ((this.shaderParts = new Map([
            [u.FRAGMENT_HEAD, null],
            [u.FRAGMENT_MAIN_UV, null],
            [u.FRAGMENT_MAIN_IMAGE, null],
            [u.VERTEX_HEAD, null],
            [u.VERTEX_MAIN_SUPPORT, null],
          ])),
      ...
      (_ = class {
        ...
        setMaterial(e) {
          if ((this.disposeMaterials(), (this.material = e), e !== null)) {
            ...
            for (const i of t)
              ((i.uniforms = Object.assign({}, e.uniforms)), (i.side = kt));
            ((t[2].skinning = !0),
      ...
      (m = -1),
      (I = class extends ae {
        constructor(e, t = m, i = m, r = 1) {
          (super(),
            (this.resizable = e),
            (this.baseSize = new f(1, 1)),
            (this.preferredSize = new f(t, i)),
            (this.target = this.preferredSize),
            (this.s = r),
            (this.effectiveSize = new f()),
        ...
        set scale(e) {
          this.s !== e &&
            ((this.s = e),
            this.preferredSize.setScalar(m),
      ...
      (ke = class extends ae {
        ...
        getShaderCode() {
          return Ye.get(this.blendFunction);
        }
      }),
      ($ = {
        VERY_SMALL: 0,
      ...
      (Ve = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
      ...
      (xt = class extends E {
        ...
        render(e, t, i, r, s) {
          ...
          for (let M = 0, H = B.length; M < H; ++M) {
            const z = M & 1 ? l : o;
            ((d.kernel = B[M]),
              (d.inputBuffer = g.texture),
              e.setRenderTarget(z),
              e.render(n, a),
              (g = z));
          }
          ((this.fullscreenMaterial = this.copyMaterial),
            (this.copyMaterial.inputBuffer = g.texture),
        ...
        initialize(e, t, i) {
          i !== void 0 &&
            ...
            i !== R
              ...
              : e !== null &&
                e.outputColorSpace === D &&
                ((this.renderTargetA.texture.colorSpace = D),
                (this.renderTargetB.texture.colorSpace = D)));
        }
        static get AUTO_SIZE() {
          return I.AUTO_SIZE;
        }
...
gl_FragColor=vec4(l);
      ...
      (je = class extends S {
        constructor(e = !1, t = null) {
          (super({
            ...
            defines: { THREE_REVISION: X.replace(/\D+/g, "") },
            uniforms: {
              inputBuffer: new c(null),
              threshold: new c(0),
              smoothing: new c(1),
      ...
      (Ze = class extends E {
        constructor({
          ...
          resolutionScale: r = 1,
          width: s = I.AUTO_SIZE,
          height: n = I.AUTO_SIZE,
          resolutionX: a = s,
          resolutionY: o = n,
        } = {}) {
          (super("LuminancePass"),
            (this.fullscreenMaterial = new je(i, t)),
            (this.needsSwap = !1),
            (this.renderTarget = e),
            this.renderTarget === void 0 &&
              ((this.renderTarget = new w(1, 1, { depthBuffer: !1 })),
              (this.renderTarget.texture.name = "LuminancePass.Target")));
          const l = (this.resolution = new I(this, a, o, r));
      ...
      (mt = class extends E {
        constructor(e, t, i = null) {
          (super("RenderPass", e, t),
            (this.needsSwap = !1),
            (this.clearPass = new b()),
            (this.overrideMaterialManager = i === null ? null : new _(i)),
        ...
        set overrideMaterial(e) {
          ...
          e !== null
            ? t !== null
              ? t.setMaterial(e)
              : (this.overrideMaterialManager = new _(e))
            : t !== null &&
      ...
      (Bt = class extends G {
        constructor({
          blendFunction: e = A.SRC,
          hue: t = 0,
          saturation: i = 0,
        } = {}) {
          (super("HueSaturationEffect", qe, {
            blendFunction: e,
            uniforms: new Map([
              ["hue", new c(new Nt())],
              ["saturation", new c(i)],
      ...
      (te = { DEPTH: 0, LUMA: 1, COLOR: 2 }),
      (_e = { DISABLED: 0, DEPTH: 1, CUSTOM: 2 }),
      (y = { LOW: 0, MEDIUM: 1, HIGH: 2, ULTRA: 3 }),
      (v = {
        LINEAR: 0,
        REINHARD: 1,
        REINHARD2: 2,
      ...
      ($e = `varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
...
vec4 delta;vec3 c=texture2D(inputBuffer,vUv).rgb;vec3 cLeft=texture2D(inputBuffer,vUv0).rgb;vec3 t=abs(c-cLeft);delta.x=max(max(t.r,t.g),t.b);vec3 cTop=texture2D(inputBuffer,vUv1).rgb;t=abs(c-cTop);delta.y=max(max(t.r,t.g),t.b);vec2 edges=step(threshold,delta.xy);if(dot(edges,vec2(1.0))==0.0){discard;}vec3 cRight=texture2D(inputBuffer,vUv2).rgb;t=abs(c-cRight);delta.z=max(max(t.r,t.g),t.b);vec3 cBottom=texture2D(inputBuffer,vUv3).rgb;t=abs(c-cBottom);delta.w=max(max(t.r,t.g),t.b);vec2 maxDelta=max(delta.xy,delta.zw);vec3 cLeftLeft=texture2D(inputBuffer,vUv4).rgb;t=abs(c-cLeftLeft);delta.z=max(max(t.r,t.g),t.b);vec3 cTopTop=texture2D(inputBuffer,vUv5).rgb;t=abs(c-cTopTop);delta.w=max(max(t.r,t.g),t.b);maxDelta=max(maxDelta.xy,delta.zw);float finalDelta=max(maxDelta.x,maxDelta.y);edges*=step(finalDelta,LOCAL_CONTRAST_ADAPTATION_FACTOR*delta.xy);gl_FragColor=vec4(edges,0.0,1.0);
      ...
      (et = `uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
#if EDGE_DETECTION_MODE != 0
varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;
#endif
...
gl_Position=vec4(position.xy,1.0,1.0);}`),
      (tt = class extends S {
        constructor(e = new f(), t = te.COLOR) {
          (super({
            name: "EdgeDetectionMaterial",
            defines: {
              THREE_REVISION: X.replace(/\D+/g, ""),
      ...
      (it = `#define sampleLevelZeroOffset(t, coord, offset) texture2D(t, coord + offset * texelSize)
#if __VERSION__ < 300
...
vec2 d;vec3 coords;coords.x=searchXLeft(vOffset[0].xy,vOffset[2].x);coords.y=vOffset[1].y;d.x=coords.x;float e1=texture2D(inputBuffer,coords.xy).r;coords.z=searchXRight(vOffset[0].zw,vOffset[2].y);d.y=coords.z;d=round(resolution.xx*d+-vPixCoord.xx);vec2 sqrtD=sqrt(abs(d));float e2=sampleLevelZeroOffset(inputBuffer,coords.zy,vec2(1,0)).r;weights.rg=area(sqrtD,e1,e2,subsampleIndices.y);coords.y=vUv.y;detectHorizontalCornerPattern(weights.rg,coords.xyzy,d);
      ...
      (wt = class extends G {
        constructor({
          blendFunction: e = A.SRC,
          preset: t = y.MEDIUM,
          edgeDetectionMode: i = te.COLOR,
          predicationMode: r = _e.DISABLED,
        } = {}) {
          super("SMAAEffect", nt, {
            vertexShader: at,
            blendFunction: e,
            attributes: C.CONVOLUTION | C.DEPTH,
            uniforms: new Map([["weightMap", new c(null)]]),
          });
          let s, n;
          (arguments.length > 1 &&
            ((s = arguments[0]),
        ...
        dispose() {
          ...
          (e !== null && t !== null && (e.dispose(), t.dispose()),
            super.dispose());
        }
...
l0=max(minLuminance,l0);l1=max(minLuminance,l1);float adaptedLum=l0+(l1-l0)*(1.0-exp(-deltaTime*tau));gl_FragColor=(adaptedLum==1.0)?vec4(1.0):packFloatToRGBA(adaptedLum);}`),
      ...
      (At = class extends E {
        constructor(e, { minLuminance: t = 0.01, adaptationRate: i = 1 } = {}) {
          (super("AdaptiveLuminancePass"),
            (this.fullscreenMaterial = new ct()),
            (this.needsSwap = !1),
            (this.renderTargetPrevious = new w(1, 1, {
              minFilter: Y,
              magFilter: Y,
              depthBuffer: !1,
            })),
          ...
          ((r.luminanceBuffer0 = this.renderTargetPrevious.texture),
            ...
            (this.copyPass = new Z(this.renderTargetPrevious, !1)));
        }
        get texture() {
        ...
        render(e, t, i, r, s) {
          ((this.fullscreenMaterial.deltaTime = r),
            e.setRenderTarget(
      ...
      (lt = `#include <tonemapping_pars_fragment>
...
outputColor=vec4(toneMapping(inputColor.rgb),inputColor.a);
      ...
      (Tt = class extends G {
        constructor({
          blendFunction: e = A.SRC,
          adaptive: t = !1,
          mode: i = t ? v.REINHARD2_ADAPTIVE : v.AGX,
          resolution: r = 256,
          maxLuminance: s = 4,
          whitePoint: n = s,
          middleGrey: a = 0.6,
          ...
          (super("ToneMappingEffect", lt, {
            ...
            (this.luminancePass = new Ze({
              renderTarget: this.renderTargetLuminance,
            })),
            (this.adaptiveLuminancePass = new At(this.luminancePass.texture, {
              minLuminance: o,
              adaptationRate: d,
            })),
        ...
        set mode(e) {
          if (this.mode !== e) {
            ...
            ((this.adaptiveLuminancePass.enabled = e === v.REINHARD2_ADAPTIVE),
              this.setChanged());
          }
        }
        getMode() {
...
#include <dithering_fragment>
      ...
      (ht = class extends S {
        constructor(e, t, i, r, s = !1) {
          (super({
            ...
            uniforms: {
              inputBuffer: new c(null),
              depthBuffer: new c(null),
              resolution: new c(new f()),
              texelSize: new c(new f()),
        ...
        setShaderParts(e) {
          return (
            (this.fragmentShader = ut
              .replace(u.FRAGMENT_HEAD, e.get(u.FRAGMENT_HEAD) || "")
              .replace(u.FRAGMENT_MAIN_UV, e.get(u.FRAGMENT_MAIN_UV) || "")
              .replace(
                u.FRAGMENT_MAIN_IMAGE,
                e.get(u.FRAGMENT_MAIN_IMAGE) || "",
              )),
            (this.vertexShader = dt
              .replace(u.VERTEX_HEAD, e.get(u.VERTEX_HEAD) || "")
              .replace(
                u.VERTEX_MAIN_SUPPORT,
                e.get(u.VERTEX_MAIN_SUPPORT) || "",
              )),
            (this.fragmentShader = J(this.fragmentShader)),
            (this.needsUpdate = !0),
            this
    ...
    function Gt(e, t, i) {
      ...
      if (a && i.attributes & C.CONVOLUTION)
        throw new Error(
        ...
        );
      {
        const o = /\w+\s+(\w+)\([\w\s,]*\)\s*{/g,
          l = i.shaderParts;
        let d = l.get(u.FRAGMENT_HEAD) || "",
          B = l.get(u.FRAGMENT_MAIN_UV) || "",
          g = l.get(u.FRAGMENT_MAIN_IMAGE) || "",
          M = l.get(u.VERTEX_HEAD) || "",
          H = l.get(u.VERTEX_MAIN_SUPPORT) || "";
        const z = new Set(),
          x = new Set();
        if (
          (a &&
...
`),
          ...
          const h = /mainSupport *\([\w\s]*?uv\s*?\)/.test(s);
          ((H += `	${e}MainSupport(`),
            (H += h
              ? `vUv);
`
              : `);
`));
          for (const p of s.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))
            for (const ne of p[1].split(/\s*,\s*/))
              (i.varyings.add(ne), z.add(ne), x.add(ne));
          for (const p of s.matchAll(o)) x.add(p[1]);
        }
        for (const h of r.matchAll(o)) x.add(h[1]);
        for (const h of t.defines.keys()) x.add(h.replace(/\([\w\s,]*\)/g, ""));
        for (const h of t.uniforms.keys()) x.add(h);
        (x.delete("while"),
          x.delete("for"),
          x.delete("if"),
          t.uniforms.forEach((h, p) =>
            i.uniforms.set(e + p.charAt(0).toUpperCase() + p.slice(1), h),
          ),
          t.defines.forEach((h, p) =>
            i.defines.set(e + p.charAt(0).toUpperCase() + p.slice(1), h),
          ));
        const se = new Map([
          ["fragment", r],
          ["vertex", s],
        ...
        (gt(e, x, i.defines),
          ...
          (s = se.get("vertex")));
        const N = t.blendMode;
        if ((i.blendModes.set(N.blendFunction, N), n)) {
	...
	`),
            t.outputColorSpace !== Et
              ? (i.colorSpace = t.outputColorSpace)
              : t.inputColorSpace !== null &&
                (i.colorSpace = t.inputColorSpace));
          const h = /MainImage *\([\w\s,]*?depth[\w\s,]*?\)/;
          ((g += `${e}MainImage(color0, UV, `),
            i.attributes & C.DEPTH &&
              h.test(r) &&
              ((g += "depth, "), (i.readDepth = !0)),
            (g += `color1);
	`));
          const p = e + "BlendOpacity";
          (i.uniforms.set(p, N.opacity),
            (g += `color0 = blend${N.blendFunction}(color0, color1, ${p});
...
`),
          s !== null &&
            (M +=
              ...
              `
`),
          l.set(u.FRAGMENT_HEAD, d),
          l.set(u.FRAGMENT_MAIN_UV, B),
          l.set(u.FRAGMENT_MAIN_IMAGE, g),
          l.set(u.VERTEX_HEAD, M),
          l.set(u.VERTEX_MAIN_SUPPORT, H),
          t.extensions !== null)
        )
          for (const h of t.extensions) i.extensions.add(h);
      }
    }
    St = class extends E {
      constructor(e, ...t) {
        (super("EffectPass"),
          (this.fullscreenMaterial = new ht(null, null, null, e)),
      ...
      updateMaterial() {
        ...
        for (const a of this.effects)
          if (a.blendMode.blendFunction === A.DST)
            e.attributes |= a.getAttributes() & C.DEPTH;
          else {
            if (e.attributes & a.getAttributes() & C.CONVOLUTION)
              throw new Error(
                `Convolution effects cannot be merged (${a.name})`,
              );
            Gt("e" + t++, a, e);
          }
        let i = e.shaderParts.get(u.FRAGMENT_HEAD),
          r = e.shaderParts.get(u.FRAGMENT_MAIN_IMAGE),
          s = e.shaderParts.get(u.FRAGMENT_MAIN_UV);
        const n = /\bblend\b/g;
...
` + s),
          ...
          e.shaderParts.set(u.FRAGMENT_HEAD, i),
          e.shaderParts.set(u.FRAGMENT_MAIN_IMAGE, r),
          e.shaderParts.set(u.FRAGMENT_MAIN_UV, s));
